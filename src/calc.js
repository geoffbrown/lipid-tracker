...
/* Martin-Hopkins adjustable divisor, keyed on triglycerides. Each entry is
   [upperBound, divisor] and applies to TG strictly below that bound, so
   TG 99 -> 6.6 while TG 100 -> 6.2. Ordering and strictness are load-bearing:
   shifting a boundary by one unit silently changes every LDL this app reports. */
